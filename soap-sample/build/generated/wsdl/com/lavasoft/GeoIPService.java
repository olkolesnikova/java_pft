 ...
 * 2020-02-29T12:11:15.838+05:00
 * Generated source version: 3.3.5
 *
 */
@WebServiceClient(name = "GeoIPService",
                  wsdlLocation = "file:src/main/resources/ipservice.xml",
...
public class GeoIPService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:src/main/resources/ipservice.xml");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(GeoIPService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:src/main/resources/ipservice.xml");
        }
        WSDL_LOCATION = url;
    }
